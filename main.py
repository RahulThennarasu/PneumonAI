...
def main():
    ...
    if file is not None:
        ...
        st.markdown("""
            ...
            pus (purulent material), causing cough with phlegm or pus, fever, chills, and difficulty breathing. A variety 
            of organisms, including bacteria, viruses, and fungi, can cause pneumonia. Pneumonia can range in seriousness 
            from mild to life-threatening and is most serious for infants and young children, people older than age 65, 
